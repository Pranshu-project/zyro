...
interface ProjectFormModalEditProps {
...
const ProjectFormModalEdit: React.FC<ProjectFormModalEditProps> = ({
  initialData,
  onSubmit,
  onCancel,
  isSubmitting,
}) => {
  const [project, setProject] = useState<ProjectFormData>(initialData);
